...
class _ApiService implements ApiService {
  ...
  Future<TopicResponse> getListTopics(
    ...
    final _options = _setStreamType<TopicResponse>(
  ...
  Future<ResponseModel> setSettingsNotify(
    ...
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'enabled': enabled, 'options': options};
    final _options = _setStreamType<ResponseModel>(
  ...
  Future<StatusesModel> getStatusesNotify(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<StatusesModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<CampaignsResponse> getListCampaigns(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CampaignsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/campaigns',
  ...
  Future<DeeplinkModel> getInviteLinkCampaigns(
    ...
    final _options = _setStreamType<DeeplinkModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<RedeemUseModel> useRedeemCode(
    ...
    final _options = _setStreamType<RedeemUseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<ActivationFunctionModel> getActivationFunctions(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ActivationFunctionModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
